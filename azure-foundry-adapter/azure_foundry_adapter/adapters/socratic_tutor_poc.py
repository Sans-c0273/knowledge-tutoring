...
`socratic-tutor-poc/src/socratic_tutor/providers/azure_foundry.py` — it
imports that project's own `socratic_tutor.providers.base`, so it will NOT
import successfully from inside this `azure-foundry-adapter` folder. See
`INTEGRATION.md` next to this file for the exact few lines to add to
`config.py` and `providers/__init__.py` once you do copy it over.
